...
local function publicApiTable()
  local t = {
    ...
    ["Cyberlibs.PrintAttribute(fileNameOrPath, attribute, forceLog)"] = {
      ...
      -- 'FilePath', 'FileSize', 'Import', 'LoadAddress', 'MappedSize', 'Version'
      Cyberlibs.PrintAttribute(fileNameOrPath, attribute, forceLog)]]
    },
...
local function gameModulesTable()
  local t = {
...
local function gameModulesStructsTable()
  local t = {
...
function help.getTable()
  local t = {
    ["Cyberlibs API"] = function() return publicApiTable() end,
    ["GameModule Class"] = function() return gameModulesTable() end,
    ["GameModule Additional Structs"] = function() return gameModulesStructsTable() end,
  }
